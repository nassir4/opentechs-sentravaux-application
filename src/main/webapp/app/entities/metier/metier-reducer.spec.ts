...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './metier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_METIER_LIST actions', async () => {
    ...
    it('dispatches FETCH_METIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_METIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_METIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_METIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_METIER actions', async () => {
      const expectedActions = [
        {
