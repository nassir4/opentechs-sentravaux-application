...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './annonce.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANNONCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANNONCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANNONCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANNONCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANNONCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANNONCE actions', async () => {
      const expectedActions = [
        {
