...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './publicite.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUBLICITE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PUBLICITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PUBLICITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PUBLICITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PUBLICITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PUBLICITE actions', async () => {
      const expectedActions = [
        {
