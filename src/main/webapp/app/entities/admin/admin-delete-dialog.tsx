...
export const AdminDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const handleClose = () => {
    props.history.push('/admin' + props.location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sentravauxV1App.admin.delete.question">
        <Translate contentKey="sentravauxV1App.admin.delete.question" interpolate={{ id: adminEntity.id }}>
