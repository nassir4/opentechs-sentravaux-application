  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sentravauxV1App.admin.home.createOrEditLabel" data-cy="AdminCreateUpdateHeading">
            <Translate contentKey="sentravauxV1App.admin.home.createOrEditLabel">Create or edit a Admin</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sentravauxV1App.admin.telephone')}
                id="admin-telephone"
                name="telephone"
                data-cy="telephone"
                type="text"
              ...
              />
              <ValidatedField id="admin-user" name="user" data-cy="user" label={translate('sentravauxV1App.admin.user')} type="select">
                <option value="" key="0" />
                {users
