    ...
    <Row>
      <Col md="8">
        <h2 data-cy="clientDetailsHeading">
          <Translate contentKey="sentravauxV1App.client.detail.title">Client</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="telephone">
              <Translate contentKey="sentravauxV1App.client.telephone">Telephone</Translate>
            </span>
          </dt>
          <dd>{clientEntity.telephone}</dd>
          <dt>
            <Translate contentKey="sentravauxV1App.client.user">User</Translate>
          </dt>
          <dd>{clientEntity.user ? clientEntity.user.id : ''}</dd>
          <dt>
            <Translate contentKey="sentravauxV1App.client.adresse">Adresse</Translate>
          </dt>
