  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sentravauxV1App.client.home.createOrEditLabel" data-cy="ClientCreateUpdateHeading">
            <Translate contentKey="sentravauxV1App.client.home.createOrEditLabel">Create or edit a Client</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sentravauxV1App.client.telephone')}
                id="client-telephone"
                name="telephone"
                data-cy="telephone"
                type="text"
              ...
              />
              <ValidatedField id="client-user" name="user" data-cy="user" label={translate('sentravauxV1App.client.user')} type="select">
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="adresse"
                data-cy="adresse"
                label={translate('sentravauxV1App.client.adresse')}
                type="select"
              >
                <option value="" key="0" />
                {adresses
