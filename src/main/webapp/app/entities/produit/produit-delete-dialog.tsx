...
export const ProduitDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sentravauxV1App.produit.delete.question">
        <Translate contentKey="sentravauxV1App.produit.delete.question" interpolate={{ id: produitEntity.id }}>
