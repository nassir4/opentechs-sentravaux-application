...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './adresse.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRESSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADRESSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADRESSE actions', async () => {
      const expectedActions = [
        {
