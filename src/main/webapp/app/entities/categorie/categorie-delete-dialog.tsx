...
export const CategorieDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sentravauxV1App.categorie.delete.question">
        <Translate contentKey="sentravauxV1App.categorie.delete.question" interpolate={{ id: categorieEntity.id }}>
