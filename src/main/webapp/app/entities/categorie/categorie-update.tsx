  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sentravauxV1App.categorie.home.createOrEditLabel" data-cy="CategorieCreateUpdateHeading">
            <Translate contentKey="sentravauxV1App.categorie.home.createOrEditLabel">Create or edit a Categorie</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sentravauxV1App.categorie.nomCategorie')}
              ...
              />
              <ValidatedField
                label={translate('sentravauxV1App.categorie.description')}
