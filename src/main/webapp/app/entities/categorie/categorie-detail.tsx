    ...
    <Row>
      <Col md="8">
        <h2 data-cy="categorieDetailsHeading">
          <Translate contentKey="sentravauxV1App.categorie.detail.title">Categorie</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nomCategorie">
              <Translate contentKey="sentravauxV1App.categorie.nomCategorie">Nom Categorie</Translate>
            </span>
          </dt>
          <dd>{categorieEntity.nomCategorie}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="sentravauxV1App.categorie.description">Description</Translate>
            </span>
          </dt>
