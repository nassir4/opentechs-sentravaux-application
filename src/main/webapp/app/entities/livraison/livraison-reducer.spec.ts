...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './livraison.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVRAISON_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIVRAISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIVRAISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIVRAISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIVRAISON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIVRAISON actions', async () => {
      const expectedActions = [
        {
