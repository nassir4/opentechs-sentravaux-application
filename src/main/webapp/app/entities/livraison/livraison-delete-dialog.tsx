...
export const LivraisonDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sentravauxV1App.livraison.delete.question">
        <Translate contentKey="sentravauxV1App.livraison.delete.question" interpolate={{ id: livraisonEntity.id }}>
