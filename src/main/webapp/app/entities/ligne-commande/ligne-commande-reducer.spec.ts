...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIGNECOMMANDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIGNECOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIGNECOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIGNECOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIGNECOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIGNECOMMANDE actions', async () => {
      const expectedActions = [
        {
