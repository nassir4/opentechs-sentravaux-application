...
export const LigneCommandeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sentravauxV1App.ligneCommande.delete.question">
        <Translate contentKey="sentravauxV1App.ligneCommande.delete.question" interpolate={{ id: ligneCommandeEntity.id }}>
