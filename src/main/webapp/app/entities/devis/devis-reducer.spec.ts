...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './devis.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEVIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEVIS actions', async () => {
      const expectedActions = [
        {
