...
export default class OuvrierUpdatePage {
  pageTitle: ElementFinder = element(by.id('sentravauxV1App.ouvrier.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  telephoneInput: ElementFinder = element(by.css('input#ouvrier-telephone'));
  userSelect: ElementFinder = element(by.css('select#ouvrier-user'));
  adresseSelect: ElementFinder = element(by.css('select#ouvrier-adresse'));
