...
import com.opentechs.sentravaux.repository.CommandeRepository;
import com.opentechs.sentravaux.service.dto.CommandeDTO;
import com.opentechs.sentravaux.service.mapper.CommandeMapper;
...
class CommandeResourceIT {
    ...
    private static final Integer DEFAULT_QUANTITE_TOTAL = 1;
    private static final Integer UPDATED_QUANTITE_TOTAL = 2;

    private static final Integer DEFAULT_PRIX_TOTAL = 1;
    private static final Integer UPDATED_PRIX_TOTAL = 2;
    ...
    void getAllCommandes() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.[*].quantiteTotal").value(hasItem(DEFAULT_QUANTITE_TOTAL)))
    ...
    void getCommande() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.quantiteTotal").value(DEFAULT_QUANTITE_TOTAL))
    ...
    void putNewCommande() throws Exception {
        ...
        updatedCommande.quantiteTotal(UPDATED_QUANTITE_TOTAL).prixTotal(UPDATED_PRIX_TOTAL).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.quantiteTotal(UPDATED_QUANTITE_TOTAL);
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.quantiteTotal(UPDATED_QUANTITE_TOTAL).prixTotal(UPDATED_PRIX_TOTAL).createdAt(UPDATED_CREATED_AT);
