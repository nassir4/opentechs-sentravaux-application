...
import com.opentechs.sentravaux.repository.CategorieRepository;
import com.opentechs.sentravaux.service.dto.CategorieDTO;
import com.opentechs.sentravaux.service.mapper.CategorieMapper;
...
class CategorieResourceIT {
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().nomCategorie(DEFAULT_NOM_CATEGORIE).description(DEFAULT_DESCRIPTION);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().nomCategorie(UPDATED_NOM_CATEGORIE).description(UPDATED_DESCRIPTION);
        return categorie;
    }
    ...
    void putNewCategorie() throws Exception {
        ...
        updatedCategorie.nomCategorie(UPDATED_NOM_CATEGORIE).description(UPDATED_DESCRIPTION);
