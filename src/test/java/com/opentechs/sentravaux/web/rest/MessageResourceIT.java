...
import com.opentechs.sentravaux.repository.MessageRepository;
import com.opentechs.sentravaux.service.dto.MessageDTO;
import com.opentechs.sentravaux.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().message(DEFAULT_MESSAGE);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().message(UPDATED_MESSAGE);
        return message;
    }
    ...
    void putNewMessage() throws Exception {
        ...
        updatedMessage.message(UPDATED_MESSAGE);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.message(UPDATED_MESSAGE);
